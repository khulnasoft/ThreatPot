...
- Start ThreatPot containers (see [docs](https://threatpot.readthedocs.io/en/latest/Installation.html)). Original dockerized app is accessible on `http://localhost:80`
