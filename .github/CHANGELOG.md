...
## [v1.2.1](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.2.1)
...
## [v1.2.0](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.2.0)
**New features**
...
## [v1.1.1](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.1.1)
Various fixes to the previous release

## [v1.1.0](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.1.0)
**New features**
...
## [v1.0.2](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.0.2)
* Added Installer Script for ThreatPot directly on a TPOT
* other tweaks to deployment and Nginx


## [v1.0.1](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.0.1)

Added support for all the other available honeypots! (#86)

## [v1.0.0](https://github.com/khulnasoft/ThreatPot/releases/tag/v1.0.0)
